...
const EditProductAdminpage = ({close,data : Productprops,fetchProductData}) => {
  ...
  return (
    <section className='fixed top-0 right-0 left-0 bottom-0 bg-neutral-900 z-50 bg-opacity-70 p-4'>

...
export const CalculateDiscount = (price,dis=1)=>{
...
export const paymentController = async(request,response)=>{
    ...
    try{
       ...
       console.log("totalam",totalAmt)
       console.log("addressid",addressId)
       console.log("subtotalamot",subTotalAmt)
...
// stripe sending id to our localhost server for verification 
...
export const webhookStripe = async(request,response)=>{
    ...
    case 'checkout.session.completed':
      ...
      if(Boolean(order[0])){
        const removeItemFromUserCart = await UserModel.findByIdAndUpdate(userId,{
            shopping_cart : []
        })
